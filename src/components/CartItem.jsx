...
import { DeleteItem, IncreaseQty, DecreaseQty } from "../redux/cartSlice";
      ...
      <div className='w-[60%] h-full flex gap-1'>
        ...
        <div className='w-[40%] h-full flex flex-col gap-5 p-1'>
            ...
            <div className='w-[110px] h-[50px] flex rounded-lg text-green-400 border-1 font-semibold overflow-hidden shadow-lg text-xl'>
                <button className='w-[30%] flex justify-center items-center hover:bg-gray-200 cursor-pointer' onClick={()=>dispatch(DecreaseQty(id))}>-</button>
                <span className='w-[40%] bg-slate-200 flex justify-center items-center'>{qty}</span>
                <button className='w-[30%] flex justify-center items-center hover:bg-gray-200 cursor-pointer' onClick={()=>dispatch(IncreaseQty(id))}>+</button>
            </div>
        </div>
      </div>
